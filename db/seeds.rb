# coding: utf-8
# レディース
lady = Category.create({id:1,name: "レディース"})
...
# メンズ
men = Category.create({id:200,name: "メンズ"})
...
# ベビー・キッズ
baby_kids = Category.create({id:346,name: "ベビー・キッズ"})
...
# インテリア・住まい・小物
interior_residence_accessory = Category.create({id:481,name: "インテリア・住まい・小物"})
...
# 本・音楽・ゲーム
book_music_game = Category.create({id:625,name: "本・音楽・ゲーム"})
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = Category.create({id:685,name: "おもちゃ・ホビー・グッズ"})
...
# コスメ・香水・美容
cosme_perfume_beauty = Category.create({id:798,name: "コスメ・香水・美容"})
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = Category.create({id:898,name: "家電・スマホ・カメラ"})
...
# スポーツ・レジャー
sport_leisure = Category.create({id:984,name: "スポーツ・レジャー"})
...
# ハンドメイド
handmade = Category.create({id:1093,name: "ハンドメイド"})
...
# チケット
ticket = Category.create({id:1147,name: "チケット"})
...
# 自動車・オートバイ
car_motorcycle = Category.create({id:1207,name: "自動車・オートバイ"})
...
# その他
others = Category.create({id:1270,name: "その他"})
